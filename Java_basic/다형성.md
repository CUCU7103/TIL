...
public class PolyMain {
    ...
    public static void main(String[] args) {
        ...
        // Child child1 = new Parents(); 자식은 부모를 담을 수 없다.
...
### instance of
- 현재 변수가 참조하고 있는 인스턴스의 타입을 확인하고자 할 때 사용하는 키워드이다.
...
public class CastingMain5 {
    ...
    private static void call(Parent parent){
        ...
        if(parent instanceof Child){
            System.out.println("Child 인스턴스 적용");
...
java 16에서는 instanceof를 사용하면서 동시에 변수선언이 가능하다.
```
    private static void call(Parent parent) {
        parent.parentMethod();
