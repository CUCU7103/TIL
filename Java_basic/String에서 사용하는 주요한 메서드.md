...
## String이 가지고 있는 메서드는 상당히 많기에 주기적으로 찾아보면서 익숙해지도록 하는 것이 좋을것 같다.
...
- compareTo()
    - 비교 대상 문자열의 각 문자들을 첫번째 부터 하나씩 비교하다가 가장 먼저 만나는 다른 문자들의 아스키 코드 값 차이를 반환하고 끝냅니다.
...
숫자의 문자열 값: 100
불리언의 문자열 값: true
객체의 문자열 값: java.lang.Object@6d311334
빈문자열 + num:100
문자열을 문자 배열로 변환: [C@3d075dc0 ,참조값
Hello, Java! // 문자열 배열확인
=====================================================
